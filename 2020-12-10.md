...
* Convertir lista de deseos a carrido enviado por Whatsapp
* Mostrar en un dibujo bar y número de personas en el bar
* Distancia entre personas GPS con sus preferencias asociadas a una tabla auxiliar
* Generar QR con la comanda de un bar y procesar el pago
* Productos lista deseos a Amazon
