...
- Instalar un Wordpress de forma automática para cada usuario de una lista (junto con varios plugins que se encuentra su nombre en un fichero)
- Ejercicio anterior añadiendo post de forma automática con acontencimientos historicos por día (https://www.jesusninoc.com/10/27/listar-acontecimientos-historicos-utilizando-powershell/)
