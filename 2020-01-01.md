...
# Nuevas ideas
- Crear para cada usuario una zona dentro de WordPress (el nombre del usuario es el número de télefono, la información sobre el usuario se genera de forma aleatoria con un API)
