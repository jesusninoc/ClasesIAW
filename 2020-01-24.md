...
#### El administrador pide eliminar trabajos de impresión que sean mayores de 10 MB, la petición web es:
```
http://localhost/P001/default.php?enviar=print&trabajos=10
```
### El administrador pide realizar una conexión por SSH
```
http://localhost/P001/default.php?enviar=connection&trabajos=192.168.1.5
```
